...
int main()
{
    ...
    printf("test MMU protection: try to access VA = 2mB\n");
    p = (int *)(2*0x100000); *p = 123;
    
    printf("test MMU protection: try to access VA = 127mb\n");
    p = (int *)(127*0x100000); *p = 123;
    
    printf("test MMU protection: try to access VA = 128mb\n");
    p = (int *)(128*0x100000); *p = 123;

   printf("test MMU protection: try to access VA = 512mb\n");
